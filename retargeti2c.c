...
void RETARGET_I2CInit(){
	...
	// TODO  retargeting for Series 2 as well
	...
	//RETARGET_I2C_DEV->ROUTELOC0 = (RETARGET_I2C_DEV->ROUTELOC0 & (~_I2C_ROUTELOC0_SDALOC_MASK)) | I2C_ROUTELOC0_SDALOC_LOC5;
	//RETARGET_I2C_DEV->ROUTELOC0 = (RETARGET_I2C_DEV->ROUTELOC0 & (~_I2C_ROUTELOC0_SCLLOC_MASK)) | I2C_ROUTELOC0_SCLLOC_LOC3;
